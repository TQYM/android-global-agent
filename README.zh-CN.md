...
| `tests/`、`tools/`、`docs/` | 设备测试计划、测试 harness、UI 采集工具与项目文档 |
...
当前项目仍处于开发与研究阶段，不建议用于无人值守的生产环境或任何高风险业务。历史安全审查见 [`SECURITY_REVIEW_2026-09-05.zh-CN.md`](SECURITY_REVIEW_2026-09-05.zh-CN.md)。
